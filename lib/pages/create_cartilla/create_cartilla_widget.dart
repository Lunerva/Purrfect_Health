...
import 'create_cartilla_model.dart';
export 'create_cartilla_model.dart';

class CreateCartillaWidget extends StatefulWidget {
  const CreateCartillaWidget({super.key});

  static String routeName = 'CreateCartilla';
  static String routePath = '/createCartilla';

  @override
  State<CreateCartillaWidget> createState() => _CreateCartillaWidgetState();
}

class _CreateCartillaWidgetState extends State<CreateCartillaWidget> {
  late CreateCartillaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateCartillaModel());
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await CartillaVacunacionRecord.collection
                            .doc()
                            .set(createCartillaVacunacionRecordData(
                              mascotaID: _model.ageTextController1.text,
                              nombre: _model.ageTextController2.text,
                              veterinarioID: _model.ageTextController3.text,
                            ));
                      },
