...
class AuthenWidget extends StatefulWidget {
  ...
  static String routeName = 'Authen';
  static String routePath = '/authen';
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [Color(0xFFCDFFC8), Colors.white],
                              stops: [0.0, 1.0],
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 12.0, 0.0, 24.0),
                                                child: Text(
                                                  'Si ya posee una cuenta, puede ingresar los siguientes datos',
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 12.0, 0.0, 24.0),
                                                child: Text(
                                                  'Comience por ingresar los siguientes datos para la creación de una cuenta',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      final buttonGetMascotasResponse =
                                                          snapshot.data!;
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        ...
                        image: Image.network(
                          'https://st2.depositphotos.com/3378121/5193/i/450/depositphotos_51933801-stock-photo-labrador-puppies-in-a-basket.jpg',
                        ).image,
                      ),
