...
class _CrearCitasWidgetState extends State<CrearCitasWidget> {
  ...
  void initState() {
    ...
    _model.fechaTextController ??= TextEditingController(text: 'Fecha');
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor:
                                            (_model.motivoFocusNode?.hasFocus ??
                                                    false)
                                                ? FlutterFlowTheme.of(context)
                                                    .accent1
                                                : FlutterFlowTheme.of(context)
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .lugarTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [_model.lugarMask],
                                    ),
                                  ),
