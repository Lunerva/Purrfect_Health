...
class _CrearCartillaWidgetState extends State<CrearCartillaWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.fechaApTextController?.text = valueOrDefault<String>(
            dateTimeFormat(
              "d/M/y",
              _model.datePicked1,
          ...
          _model.proxDosisTextController?.text = valueOrDefault<String>(
            dateTimeFormat(
              "d/M/y",
              _model.datePicked2,
              locale: FFLocalizations.of(context).languageCode,
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  fillColor:
                                      (_model.fechaApFocusNode?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  fillColor:
                                      (_model.proxDosisFocusNode?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                validator: _model
                                    .proxDosisTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                  if (!isAndroid && !isiOS)
                                    TextInputFormatter.withFunction(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: (_model.observacionesFocusNode?.hasFocus ??
                                false)
                            ? FlutterFlowTheme.of(context).accent1
                            : FlutterFlowTheme.of(context).secondaryBackground,
                        contentPadding: EdgeInsetsDirectional.fromSTEB(
