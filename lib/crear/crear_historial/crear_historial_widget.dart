...
class _CrearHistorialWidgetState extends State<CrearHistorialWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.fechaTextController?.text = valueOrDefault<String>(
            dateTimeFormat(
              "d/M/y",
              _model.datePicked,
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFFFFDB83), Colors.white],
                stops: [0.0, 1.0],
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: (_model.descripcionFocusNode?.hasFocus ??
                                false)
                            ? FlutterFlowTheme.of(context).accent1
                            : FlutterFlowTheme.of(context).secondaryBackground,
                        contentPadding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  fillColor:
                                      (_model.fechaFocusNode?.hasFocus ?? false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                                  contentPadding:
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: (_model.veterinarioFocusNode?.hasFocus ??
                                false)
                            ? FlutterFlowTheme.of(context).accent1
                            : FlutterFlowTheme.of(context).secondaryBackground,
                        contentPadding: EdgeInsetsDirectional.fromSTEB(
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 30.0, 16.0, 30.0),
                        ...
                        return FFButtonWidget(
                          onPressed: () async {
                            await HistorialMedicoRecord.createDoc(
                              ...
                              veterinario:
                                  _model.veterinarioTextController.text,
                              mascotaID: widget.idMascoton,
                            ));

                            context.pushNamed(
                              ListaMascotasWidget.routeName,
